...
useEffect(()=>{
    ...
    return(
        ...
        <div className='my-3' style={{display:'flex',justifyContent:'center'}}><h1>Klever</h1> </div>
...
<div className='my-0'  style={{display:'flex',flexDirection:'row',justifyContent: 'space-between'}} >
    ...
    <svg id={token.id} color='white' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pen" viewBox="0 0 16 16">
